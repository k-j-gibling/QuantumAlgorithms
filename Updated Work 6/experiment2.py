...
from specificHamiltonians import prepare_H_test1, prepare_H_test2, prepare_H_test3
...
for N in N_list:
	...
	H_eff = compute_effective_hamiltonian([['X','Z'],['Z','X']], psi_0)
	#H_eff = compute_effective_hamiltonian_normalized(H_N_list, psi_0, N)
...
for N in N_list:
	...
	#Get the corresponding effective Hamiltonian.
	H_eff = compute_effective_hamiltonian([['X','Z','Z'],['Z','X','Z'],['Z','Z','X']], psi_0)
	#H_eff = compute_effective_hamiltonian_normalized(H_N_list, psi_0, N)
